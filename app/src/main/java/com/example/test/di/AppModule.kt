...
import com.example.test.data.datasources.network.MarvelMockApi
...
object AppModule {
    ...
    fun providesApi(retrofit: Retrofit): MarvelApi {
        return if (BuildConfig.BUILD_TYPE.contentEquals("mock")) MarvelMockApi()
        else retrofit.create(MarvelApi::class.java)
    }
}